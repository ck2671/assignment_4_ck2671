...
![](../results/horse_pops_plot.png){#fig-horsepop width=85%}

**@fig-horsepop**: Horse populations for all provinces in Canada from 1906 - 1972.

We can see from **@fig-horsepop** that Ontario, Saskatchewan and Alberta 
...
*Standard deviation of historical (1906-1972) horse populations for each Canadian province*
...
Additionally, note that in @tbl-horsesd we consider the sample standard deviation of the number of horses during the same time span as @fig-horsepop.


![](../results/horse_pop_plot_largest_sd.png){#fig-largestsd width=65%}

**@fig-largestsd**: Horse populations for **`r largest_sd`**,the province with the largest standard deviation

In **@fig-largestsd**, we zoom in and look at **`r largest_sd`**, which had the largest spread of values in terms of standard deviation.
